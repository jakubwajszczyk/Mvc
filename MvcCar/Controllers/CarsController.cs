...
namespace MvcCar.Controllers
{
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Mark,Model,YearOfProduction,Price")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Mark,Model,YearOfProduction,Price")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
